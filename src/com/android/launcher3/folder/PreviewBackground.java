...
public class PreviewBackground extends DelegatedCellDrawing {
    ...
    public void setup(Context context, ActivityContext activity, View invalidateDelegate,
        ...
        boolean isEnlarged = availableSpaceX > grid.iconSizePx * 1.5;
        ...
        Log.d("PreviewBackground", "setup: availableSpaceX=" + availableSpaceX 
            + ", iconSizePx=" + grid.iconSizePx 
            + ", folderIconSizePx=" + grid.folderIconSizePx
            + ", enlargedBySpaceCheck=" + enlargedBySpaceCheck
            + ", infoSpan=(" + infoSpanX + "," + infoSpanY + "), enlargedByInfoSpan=" + enlargedByInfoSpan
            + ", lpSpan=(" + lpSpanX + "," + lpSpanY + "), enlargedByLayoutParams=" + enlargedByLayoutParams
            + ", isEnlarged=" + isEnlarged);
        
        if (isEnlarged) {
             int targetSize = (int) (Math.min(availableSpaceX, availableSpaceX) * 0.85f);
             if (targetSize > previewSize) {
                 previewSize = targetSize;
             }
             Log.d("PreviewBackground", "setup: ENLARGED previewSize=" + previewSize + ", targetSize=" + targetSize);
        } else {
             Log.d("PreviewBackground", "setup: NOT ENLARGED previewSize=" + previewSize);
        }
