package com.android.launcher3.allapps.compose.shared.constants
...
object PreferenceKeys {
    ...
    const val SEARCH_MESSAGES = "pref_search_messages"
    const val SEARCH_FILES = "pref_search_files"
    const val SEARCH_PHOTOS = "pref_search_photos"
    const val SEARCH_CALENDAR = "pref_search_calendar"
    const val SEARCH_SETTINGS = "pref_search_settings"
    const val SEARCH_WEB = "pref_search_web"
    const val SEARCH_SHOW_WEB_ACTIONS = "pref_search_show_web_actions"
